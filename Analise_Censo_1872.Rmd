...
brks <- seq(0,200000,by=1)
brks2 <- seq(0,200000,by=20000)


#Plotando o indicador (variável) no seu arquivo shape
spplot(shape1,"total_escravisados", at=brks, col.regions=rev(brewer.pal(10,"Greens")), main="Total de escravisados por província - 1872", direction=-1)
